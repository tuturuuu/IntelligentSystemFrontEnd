...
reconstructed_model = keras.models.load_model(
    "best_TRXPred_gru_prob.keras", safe_mode=False
)
...
data = pd.read_csv('/content/drive/MyDrive/Intelligent system/Apple_20120101_to_20241212.csv')
...
best_model = load_model(f'./fulltrained_BTCPred_lstm_time_dist.keras', safe_mode = False)
